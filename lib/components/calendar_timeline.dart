  ...
  Container _buildDayList() {
    return Container(
      ...
      child: ListView.builder(
        ...
        padding: EdgeInsets.only(left: widget.leftMargin, right: 10, top: 8.0, bottom: 8.0),
    ...
    return GestureDetector(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          fontWeight: this.isSelected ? FontWeight.w500 : FontWeight.w400,
        ),
      ),
    );
  }
